...
def main(
    ...
    for folder_name in folder_names:
        if "retarget" in folder_name or "smpl" in folder_name or "h1" in folder_name:   #{aist_root_dir}/kungfu/*.[np][pk][lzy]
            # Ignore folders where we store motions retargeted to AMP
            continue

        data_dir = aist_root_dir / folder_name
        output_dir = aist_root_dir / f"{folder_name}-{append_name}"                    #output {aist_root_dir}/kungfu-{robot_type}/*
